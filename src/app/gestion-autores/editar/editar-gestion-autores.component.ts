...
@Component({
  selector: 'app-editar-gestion-autores',
  standalone: true,
  ...
  templateUrl: './editar-gestion-autores.component.html',
  styleUrl: './editar-gestion-autores.component.css'
})
export class EditarGestionAutoresComponent implements OnInit{
  ...
  formatDate(date: Date): string {
   ...
   editarAutor() {
    ...
    this.autorService.actualizar(this.id,param).subscribe((result:any) => {
      if (result.code === 1) {
