...
@Component({
  selector: 'app-ver-gestion-libros',
  standalone: true,
  ...
  templateUrl: './ver-gestion-libros.component.html',
  styleUrl: './ver-gestion-libros.component.css'
})
export class VerGestionLibrosComponent implements OnInit {
  autores:any[] = [];
  libroForm: FormGroup;
  isbn: string = ''; 
